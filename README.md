...
Domain include `already_selected` flags that indicate when a recommendation simply confirms a group's existing choice (validation) versus suggesting a new direction (discovery).
